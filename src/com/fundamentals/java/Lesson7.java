...
/*
*The content of theis class goes over the Lesson 7 content
*Java Operators
**/
...
// This method goes over Basic Math
    ...
    //This method goes after Modulus
    ...
    /* The shift left operator will tale the value as a primitive type
    ...
    public void exampleLeftShift() {
        // The number 15 converted to binary is = 111
int value = 15;
// shifting value by 2 results in 0011 1100 which is 60
    ...
    * When the value of type is long or int, the lowe-order bits of the value are
    ...
    * If the bits are different, a 1 takes its place */
    ...
    public void exampleIncrement() {
        ...
        jump = home++;
        System.out.println(jump); // answer in 10
        car = ++home;
