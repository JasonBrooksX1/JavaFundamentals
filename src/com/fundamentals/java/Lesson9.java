...
public class Lesson9 {
    // This method shows the array of int
    ...
    public void basicThreeDimensionalArray() {
        ...
        for(int i = 0; i < threeD.length; i++) {
            for (int j = 0; j < threeD[i].length; j++) {
                for (int k = 0; k < threeD[j].length; j++) {
                    System.out.println(threeD[j][j][k]);
                }// end inner inner for loop
            }// end inner for loop
        }//end outer for loop
    }// end method basicThreeDimensionalArray

    //This method goes over jagged arrays
